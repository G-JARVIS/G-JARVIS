...
![Full Stack](https://img.shields.io/badge/Full--Stack-Developer-brightgreen)

---

## 🚀 About Me
I’m **Gandharva Ugale (G-JARVIS)** — a **Full-Stack Developer**, **UI/UX Designer**, and **Java DSA practitioner**.  
Currently a **Third-Year B.Tech CSE student** at **KJ Somaiya College of Engineering, Vidyavihar**.

- Ex-CSI_KJSCE Creative Team Member  
- Somaiya SwDC Team Member  
- Passionate about building scalable web applications with clean UI and robust backend systems  
...
- Track income & expenses with category-based insights
- Secure authentication & user-specific dashboards
- Interactive charts for monthly and yearly financial analysis
- RESTful API architecture with scalable backend

**Tech Stack:** React, Node.js, Express.js, MongoDB, Chart.js, JWT

---

### 🧑‍💼 RecruitXchange
**Recruitment & Job Matching Platform**

- Role-based authentication (Recruiter & Candidate)
- Job posting, application tracking, and profile management
- Optimized search & filter for candidates and jobs
- Modular backend with clean API structure
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=flat&logo=gmail&logoColor=white)](mailto:gandharvaugale@gmail.com)
